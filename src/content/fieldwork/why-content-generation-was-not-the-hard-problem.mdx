...
<aside class="fieldwork-endmatter" aria-label="Fieldwork notes">
  ...
  <div class="fieldwork-endmatter-next">
    ...
    <p>Next: <strong>Inspiral: From Raw Documents to Governed Knowledge, Meaning and Communication</strong>—the intended architecture, the roles of ContextCore, CanonLens and ContentFlight, and the boundaries this note deliberately does not cover.</p>
  </div>
</aside>
